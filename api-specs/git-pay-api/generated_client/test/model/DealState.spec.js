...
(function(root, factory) {
  ...
  describe('DealState', function() {
    it('should create an instance of DealState', function() {
      // uncomment below and update the code to test DealState
      //var instane = new GitPayApi.DealState();
      //expect(instance).to.be.a(GitPayApi.DealState);
    });
