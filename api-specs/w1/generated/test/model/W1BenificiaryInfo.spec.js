...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new W1P2PApi.W1BenificiaryInfo();
  });
  ...
  describe('W1BenificiaryInfo', function() {
    it('should create an instance of W1BenificiaryInfo', function() {
      // uncomment below and update the code to test W1BenificiaryInfo
      //var instane = new W1P2PApi.W1BenificiaryInfo();
      //expect(instance).to.be.a(W1P2PApi.W1BenificiaryInfo);
    });
    ...
    it('should have the property redirectToPaymentToolAddition (base name: "RedirectToPaymentToolAddition")', function() {
      // uncomment below and update the code to test the property redirectToPaymentToolAddition
      //var instane = new W1P2PApi.W1BenificiaryInfo();
      //expect(instance).to.be();
    });
